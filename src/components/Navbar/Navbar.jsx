...
import './Navbar.css'
import Logo from '../../assets/university_8074800.png'
    ...
    return (
        <nav className={`container ${sticky ? 'dark-nav' : ''}`}>
            ...
            <ul className={mobileMenu?'':'hide-mobile-menu'}>
                <li><Link to='heru' smooth={true} offset={0} duration={500}>Home
                </Link></li>
                <li><Link to='programs' smooth={true} offset={-260} duration={500}>Program
                </Link></li>
